...
post(route("semester.update",semester.id));
...
return(
  ...
  <AuthenticatedLayout
    user={auth.user}
    header={<h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Edit Semester </h2>}
  ...
  <Head title="Edit Semester" />
    <div className="py-12">
     <div className="max-w-8xl mx-auto sm:px-6 lg:px-8">
       ...
       <div className='mt-4 ms-5'><p className='lead text-gray-600'>Edit Semester </p></div>
                        <form
                         onSubmit={onSubmit}
