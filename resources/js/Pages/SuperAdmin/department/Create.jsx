...
export default function Create ({auth,success,facultys}){
 ...
 return (
   ...
   <AuthenticatedLayout
    ...
    user={auth.user}
    header={<h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Add Department</h2>}
    ...
    <div className="py-12">
     ...
     <div className='mt-4 ms-5'><p className='lead text-gray-600'>Add New Department </p></div>
                     <form
                         onSubmit={onSubmit}
